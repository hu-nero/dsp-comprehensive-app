...
//#pragma CODE_SECTION(SWVer,"romfuncs");
//#pragma CODE_SECTION(SWObj,"romfuncs");
//#pragma CODE_SECTION(SWMast,"romfuncs");
...
{
    EALLOW;
    SysCtrlRegs.WDCR= 0x00e8;//0x0068
    EDIS;
}
void EnableDog(void)
{
...
void InitPll(Uint16 val, Uint16 divsel)
{
   ...
   // Change the PLLCR
   if (SysCtrlRegs.PLLCR.bit.DIV != val)//p50
   {
...
// XCLKOUT to SYSCLKOUT ratio.  By default XCLKOUT = 1/4 SYSCLKOUT
   // XTIMCLK = SYSCLKOUT/2
   XintfRegs.XINTCNF2.all=0x10004;
   // XTIMCLK = SYSCLKOUT/2,XCLKOUT = XTIMCLK/2,Enable XCLKOUT
...
void InitSysCtrl(void)
{
   ...
   /*EALLOW;
   SysCtrlRegs.SCSR=0x05;
   EDIS;*/
   

   // Initialize the PLL control: PLLCR and DIVSEL
   // DSP28_PLLCR and DSP28_DIVSEL are defined in DSP2833x_Examples.h
   InitPll(DSP28_PLLCR,DSP28_DIVSEL);//5beipin,150mhz
