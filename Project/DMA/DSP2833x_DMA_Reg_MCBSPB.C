...
void DMA_Init(void)
{
	...
	*/
//////////////////////////CH1用于SD卡接收/////////////////////////
  DmaRegs.CH1.MODE.all=0x0311;/*0000,0011,0001,0001
	  ...
	  bit6~5:Reserved,00
	  bit4~0:PERINTSEL(Peripheral Interrupt Source Select Bits),MREVTB,1,0001
	  */
  ...
  DmaRegs.CH1.SRC_BEG_ADDR_ACTIVE=(Uint32)(&McbspbRegs.DRR1.all);
  DmaRegs.CH1.SRC_ADDR_SHADOW=(Uint32)(&McbspbRegs.DRR1.all);
  DmaRegs.CH1.SRC_ADDR_ACTIVE=(Uint32)(&McbspbRegs.DRR1.all);
...
////////////////////CH2用于SD卡发送/////////////////////
	DmaRegs.CH2.MODE.all=0x0310;/*0000,0011,0001,0000
	  bit15:CHINTE(Channel Interrupt Enable Bit).Interrupt disabled,0
	  bit14:DATASIZE(Data Size Mode Bit).16-bit data transfer size,0
	  bit13:SYNCSEL(Sync Mode Select Bit).SRC wrap counter controlled,0
	  bit12:SYNCE(Sync Enable Bit).disable,0
	  ...
	  bit7:OVRINTE(Overflow Interrupt Enable).Overflow interrupt disabled,0
	  bit6~5:Reserved,00
	  bit4~0:PERINTSEL(Peripheral Interrupt Source Select Bits),MXEVTB,1,0000
	  */
  ...
  DmaRegs.CH2.DST_BEG_ADDR_SHADOW=(Uint32)(&McbspbRegs.DXR1.all);
  DmaRegs.CH2.DST_BEG_ADDR_ACTIVE=(Uint32)(&McbspbRegs.DXR1.all);
  DmaRegs.CH2.DST_ADDR_SHADOW=(Uint32)(&McbspbRegs.DXR1.all);
  DmaRegs.CH2.DST_ADDR_ACTIVE=(Uint32)(&McbspbRegs.DXR1.all);
///////////////////////////////////////////////////////////////////////////////  
